...
colorAdminApp.controller('registerAddEntriesController',
        ...
        $http.post('/dashboard/api/get-company-asset/' + $scope.new_as.asset_name + '/')
            .then(function(r){
                if(r){
                    ...
                    $scope.new_as.fixed_amount = parseFloat(r.data.asset_value);
                    $('input[name=new_fixed_amount]').attr('max',parseFloat(r.data.asset_value));
                    $scope.new_as.percent_asset_value = parseFloat(r.data.asset.asset_percent);
    ...
    $scope.open_edit_control_modal = function(index) {
        ...
        $scope.add_control.total_ale_impact_value = ($scope.add_control.total_cost_value * $scope.basicinfo.aro_rate / 100).toFixed(2);
    ...
    $scope.add_control_mitigation = function() {
        ...
        // $scope.add_control.total_ale_impact = '-$' + $scope.add_control.total_ale_impact_value;
        $scope.add_control.total_ale_impact = $scope.add_control.total_cost_value * $scope.basicinfo.aro_rate / 100;
    ...
    $scope.mitigating_controls_update = function () {
        ...
        for( i = 0 ; i < $scope.mitigating_controls.multidata.length ; i++ ){
            ...
            $scope.mitigating_controls.multidata[i].total_ale_impact = $scope.mitigating_controls.multidata[i].total_cost_value * $scope.basicinfo.aro_rate / 100;
        ...
        for( i = 0 ; i < $scope.mitigating_controls.multidata.length ; i++ ){
            ...
            $scope.mitigating_controls.multidata[i].total_cost_value = parseFloat($scope.mitigating_controls.multidata[i].total_cost_value).toFixed(2);
            $scope.mitigating_controls.multidata[i].total_ale_impact_value = parseFloat($scope.mitigating_controls.multidata[i].total_cost_value * $scope.basicinfo.aro_rate / 100).toFixed(2);
        ...
        $scope.mitigating_controls.sle_cost = parseFloat(sle_cost).toFixed(2);
        $scope.mitigating_controls.aro_cost = aro_cost.toFixed(2);
        $scope.mitigating_controls.total_cost = total_cost.toFixed(2);
        $scope.mitigating_controls.total_ale = total_ale.toFixed(2);
    }
    ...
    $scope.affected_assets_update = function(){
        ...
        for( i = 0 ; i < $scope.affected_assets.multidata.length ; i++ ){
            ...
            total_asset_value += parseFloat(edit_item.asset_value);
