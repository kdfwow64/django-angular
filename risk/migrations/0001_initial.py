# Generated by Django 2.1.3 on 2018-11-21 16:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aro_fixed', models.DecimalField(decimal_places=10, default=1, help_text='Fixed number of occurrences on an annual basis to determine total frequency per year.', max_digits=19)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_deactivated', models.DateTimeField(blank=True, help_text='Timestamp the field was last deactivated', null=True)),
                ('date_deleted', models.DateTimeField(blank=True, help_text='Timestamp the individual was created', null=True)),
                ('aro_mitigation_rate', models.FloatField(blank=True, default=0, help_text='Percentage of mitigation the control applies to the Annual Rate of Occurence')),
                ('impact_mitigation_rate', models.FloatField(blank=True, default=0, help_text='Percentage of mitigation the control applies to the Impact')),
        ...
        migrations.AddField(
            ...
            name='company',
            field=models.ForeignKey(default=1, help_text='Company id for the company that manages the field', on_delete=django.db.models.deletion.PROTECT, related_name='risk_controlnotification_related_company', to='risk.Company'),
        ),
        migrations.AddField(
            model_name='controlnotification',
            name='created_by',
            field=models.ForeignKey(default=13, help_text='User id of the user that created the field', on_delete=django.db.models.deletion.PROTECT, related_name='risk_controlnotification_related_created', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='controlnotification',
            name='deactivated_by',
            field=models.ForeignKey(blank=True, help_text='User id that last deactivated the field', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='risk_controlnotification_related_deactivated', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='controlnotification',
            name='deleted_by',
            field=models.ForeignKey(blank=True, help_text='User id that last deleted the field', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='risk_controlnotification_related_deleted', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='controlnotification',
            name='modified_by',
            field=models.ForeignKey(default=13, help_text='User id that last modified the field', on_delete=django.db.models.deletion.PROTECT, related_name='risk_controlnotification_related_modified', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='created_by',
            field=models.ForeignKey(default=13, help_text='User id of the user that created the field', on_delete=django.db.models.deletion.PROTECT, related_name='risk_controlcategorynotification_related_created', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='controlcategorynotification',
            name='deactivated_by',
            field=models.ForeignKey(blank=True, help_text='User id that last deactivated the field', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='risk_controlcategorynotification_related_deactivated', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='controlcategorynotification',
            name='deleted_by',
            field=models.ForeignKey(blank=True, help_text='User id that last deleted the field', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='risk_controlcategorynotification_related_deleted', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='controlcategorynotification',
