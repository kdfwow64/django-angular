# Generated by Django 2.1.3 on 2018-12-19 13:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(default=1, help_text='Company id for the company that manages the field', on_delete=django.db.models.deletion.PROTECT, related_name='risk_appetite_related_company', to='risk.Company')),
                ('created_by', models.ForeignKey(default=13, help_text='User id of the user that created the field', on_delete=django.db.models.deletion.PROTECT, related_name='risk_appetite_related_created', to=settings.AUTH_USER_MODEL)),
                ('deactivated_by', models.ForeignKey(blank=True, help_text='User id that last deactivated the field', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='risk_appetite_related_deactivated', to=settings.AUTH_USER_MODEL)),
                ('deleted_by', models.ForeignKey(blank=True, help_text='User id that last deleted the field', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='risk_appetite_related_deleted', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(default=13, help_text='User id that last modified the field', on_delete=django.db.models.deletion.PROTECT, related_name='risk_appetite_related_modified', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AlterModelOptions(
            name='controlcsc',
            options={'verbose_name_plural': 'Control: CSC'},
        ),
        migrations.AlterModelOptions(
            name='controlcscfamily',
            options={'verbose_name_plural': 'Control: CSC Families'},
        ),
        migrations.AlterModelOptions(
            name='controldomain',
            options={'verbose_name_plural': 'Control: Domains'},
        ),
        migrations.AlterModelOptions(
            name='controlfamily',
        ...
        migrations.AddField(
            ...
            name='date_approved',
            field=models.DateTimeField(blank=True, help_text='Timestamp the final approval of the entry', null=True),
        ),
        migrations.AddField(
            model_name='entryevaluation',
            name='date_requested',
            field=models.DateTimeField(blank=True, help_text='Timestamp the reqestor requested the evaluation', null=True),
        ),
        migrations.AddField(
            model_name='entryevaluation',
            name='request_note',
            field=models.TextField(blank=True, help_text='Notes regarding the logic of why the evaluation was requested'),
        ),
        migrations.AddField(
            model_name='entryevaluation',
            name='requestor',
